...
Semantic HTML are HTML tag that are meaningful. They are useful for accessibility and clean, readable code. Examples of Semantic tags would be <article>, <nav>, <section>, and <footer>.
